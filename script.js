/* ═══════════════════════════════════════════════════════════════
  ...
  /* ── DATI ATTIVITÀ ──────────────────────────────────────────────
     Per aggiungere un attestato scaricabile:
     1. Crea una cartella "attestati/" nella stessa cartella dei file
     2. Metti il PDF dentro (es. attestati/cisco.pdf)
     3. Imposta: attestato: 'attestati/cisco.pdf'
     ─────────────────────────────────────────────────────────────── */
  const DATI = [
    {
      anno: '2023/24',
      ...
      attivita: [
        {
          ...
          utilita: 'Ho acquisito le basi della normativa D.Lgs. 81/2008 sulla sicurezza nei luoghi di lavoro: valutazione dei rischi, dispositivi di protezione individuale, procedure di emergenza. Conoscenze fondamentali per qualsiasi futuro contesto lavorativo.'
        },
        {
          org: 'IBM SkillsBuild',
        ...
        },
        {
          ...
          logo: '🚀',
          logoColore: '#1f1218',
          sito: 'https://www.sprintschool.it',
          attestato: null,
          ...
          utilita: 'Ho sviluppato capacità di pensiero imprenditoriale, business model canvas, presentazione in pubblico e lavoro in team. Esperienza preziosa per capire come trasformare un\'idea tecnica in un prodotto vendibile.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      attivita: [
        ...
        },
        {
          ...
          attestato: null, // es: attestato: 'attestati/cisco-it-essentials.pdf'
  ...
  function apriDettaglio(att, annoObj) {
    ...
    const btnAttestato = att.attestato
      ...
      : `<span class="det-btn-nessun">Nessun attestato caricato — metti il PDF in <em>attestati/</em> e aggiorna il campo <em>attestato</em> in script.js</span>`;
